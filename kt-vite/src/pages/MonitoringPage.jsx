...
import DashboardManageModal from "./monitoring/modal/DashboardManageModal";
...
const MonitoringPage = () => {
  ...
  const [isDashboardModalOpen, setIsDashboardModalOpen] = useState(false); // 모달 열림/닫힘 상태
  ...
  const middleContent = useMemo(
    ...
    [isRealtime, dateRange, timeRangePreset, dataInterval, handleRealtimeToggle]
  );
  ...
  const rightContent = useMemo(
      ...
      <>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-2 h-8">
            <button
              className="w-8 h-8 flex items-center justify-center border border-[#e4e7e7] rounded hover:bg-gray-50"
    ...
    [dashboardMode, dashboardType, selectedDashboard]
  );
